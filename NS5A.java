...
public class NS5A extends JFrame {
   ...
   private class DrawCanvas extends JPanel {
	 ...
	 for (int i = 0; i < L; i++)
	    g.drawLine(pos[edges[i][0]][0], pos[edges[i][0]][1],
		pos[edges[i][1]][0], pos[edges[i][1]][1]);
		//code added by Akhil-starts
		for (int i=0; i < N; i++)			// Your code to drawString labels at pos
		g.drawString(labels[i],pos[i][0],pos[i][1]);
		//code ends
	 }
